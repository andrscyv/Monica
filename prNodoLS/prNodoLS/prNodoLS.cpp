// prNodoLS.cpp: define el punto de entrada de la aplicación de consola.
//
...
// =======================================
// en C cada cosa distinta de null es verdadero


class NodoLS
{
	int     dato;
	NodoLS *sig; //apuntador a un nodo :D
public:
	NodoLS(int unDato)
	{
		dato = unDato;
...
void main(int argc, char* argv[])
{
	...
	ofstream fo = ofstream("C:\\Users\\sdist\\Desktop\\Gráficas\\archivo.txt", ios::out);
	fo << a;
	...
	ifstream fin("C:\\Users\\sdist\\Desktop\\Gráficas\\archivoT.txt",ios::in);
	b.leefin(&fin);
